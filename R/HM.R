#' This function makes homozygosity/heterozygosity mating plan
#'
#' @param Mate the mating method, HOMO:homozygosity, HE:heterozygosity
#' @param path the path of mating plan
#' @param maxF the allowed maximum inbreeding coeffecients between parents. Default is 999.
#' @param Sor the number of dams mate with one sire

#' @return a list of crossplan matrix and inbreeding values
#' @export
